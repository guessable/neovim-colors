...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#1b2b34", "cterm": "235", "cterm16": "0" }),
...
let s:p.visual.right = [ [ s:black, s:red ], [ s:white, s:grey ] ]
...
let g:lightline#colorscheme#my_material#palette = lightline#colorscheme#flatten(s:p)
